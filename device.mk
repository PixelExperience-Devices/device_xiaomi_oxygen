...
VENDOR_PATH := vendor/xiaomi/oxygen
...
# Google Lens
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/pixelstyle/etc/sysconfig/pixel_2017_exclusive.xml:system/etc/sysconfig/pixel_2017_exclusive.xml \
    $(DEVICE_PATH)/pixelstyle/etc/sysconfig/pixel_2017.xml:system/etc/sysconfig/pixel_2017.xml \
    $(DEVICE_PATH)/pixelstyle/etc/sysconfig/nexus.xml:system/etc/sysconfig/nexus.xml \
    $(DEVICE_PATH)/pixelstyle/etc/sysconfig/google_build.xml:system/etc/sysconfig/google_build.xml
...
# Input
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/keylayout/ft5435_ts.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/ft5435_ts.kl \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/keylayout/ft5x46.kl:system/usr/keylayout/ft5x46.kl \
...
# Media
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/media_codecs_8953_v1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_8953_v1.xml \
    $(DEVICE_PATH)/configs/media_codecs_performance_8953_v1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance_8953_v1.xml \
